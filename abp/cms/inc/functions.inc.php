...
//header and login page
    if($is_loged_in == TRUE){ 
		...
		$skin_header = preg_replace("/{menu}/", " &nbsp; Content Management System.", "$skin_header"); 
	}
	//$config_version_name
...
function thaiis_header(){
?>

<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#000000">
  <tr>
    <td height="58" align="center">
   <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="888" height="58">
      <param name="movie" value="THAIIS_files/thaiis_topmenu.swf" />
      <param name="quality" value="high" />
      <embed src="THAIIS_files/thaiis_topmenu.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="888" height="58"></embed>
    </object></td>
  </tr>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="../THAIIS_files/webdesign_butt.gif">
  <tr> 
    <td>
...
function thaiis_footer(){
?>
	<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#000000">
    <tr>
    <td><div align="center"><a href="http://www.thaiis.info" target="_blank"><img src="THAIIS_files/footer.jpg" alt=FOOTER 
width=888 height=64 border="0"></a> </div></td>
  </tr>
</table>
<?
}
