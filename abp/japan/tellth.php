...
<table width="772" cellpadding="0" cellspacing="0" border="0" class="bghead" height="209">
  <tr> 
    <td valign="top"> <br> <table width="772" border="0">
        <tr> 
          <td width="55">&nbsp;</td>
          <td rowspan="2" valign="top"> <p><br>
              <img src="images/logo_abp.gif" width="143" height="75"></p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <br> <table width="94%" border="0">
              <tr> 
            ...
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="139" height="345">
              ...
              </embed> </object> <table width=135 border=0 cellpadding=0 cellspacing=0>
              <tr> 
          ...
          <td width="529" valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="570" height="251">
        ...
        <tr> 
          <td width="55">&nbsp;</td>
          <td width="529" valign="top"> <table width="100%">
              <tr> 
                <td width="49" valign="top">&nbsp;</td>
                <td valign="top"><font size="3"><b>友人に Links する</b></font><b> 
                  <br>
...
<? if (empty($HTTP_REFERER)) { $referrer = 'No referrer reported'; } else { $referrer = $HTTP_REFERER; } echo $referrer; ?>
                            ...
                            <br> <br> <input name="submit" type=submit value=送る></td>
                        </tr>
                      </table>
                      <div align="left"><br>
                        <br>
            ...
            <table width="516" border="0" height="34">
              <tr> 
                ...
                <td> <span class="small"><br>
                  </span> <hr> <b><span class="small"><img src="images/link.jpg" width="24" height="24"></span><font color="#CC6666">Site 
                  map</font> <br>
                  ...
                  <a href="map.htm">Map</a><b>|<a href="floorplan.htm">Floor Plan</a></b>| 
                  <a href="virtual.htm">Slide Show</a>| <a href="virtual1.htm">Landscape</a>| 
