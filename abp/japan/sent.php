...
?>
<html><!-- #BeginTemplate "/Templates/themesth.dwt" --><!-- DW6 -->
<head>
...
<link rel="stylesheet" href="abp.css" type="text/css">
        ...
        <tr> 
          ...
          <td rowspan="2" valign="top"> 
            ...
            <table width="94%" border="0">
              <tr> 
                <td><div align="center"><a href="index.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','images/langover_01.jpg',1)"><img src="images/lang_01.jpg" name="Image10" width="56" height="33" border="0"></a><a href="../eng/index.htm" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image11','','images/langover_02.jpg',1)"><img src="images/lang_02.jpg" name="Image11" width="55" height="33" border="0"></a></div></td>
              </tr>
            </table>
      
              <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="139" height="345">
            ...
            <a href="tellth.php"><img src="images/tell.gif" width="126" height="24" border="0"></a> 
            <p>&nbsp;</p>
          </td>
          ...
          <td width="529" valign="top">
            <table width="100%">
              <tr> 
                ...
                <td valign="top"><!-- #BeginEditable "boo" --> 
                    ...
                    <table width=427 border=0 align=center cellpadding=2 cellspacing=2 bgcolor="#FFFFFF">
                      ...
                      <tr bgcolor="#66CCCC"> 
                        <td width="413" bgcolor="#FFFFFF"> 
                          <div align="right"> 
                              <p align="left"><strong><font color="#666666"> <br>
...
if ($name=='') { echo "<b><font color=\"#CC9933\">font size=\"3\" face=\"Verdana, Arial, Helvetica, sans-serif\" color=\"#CC0000\">Error</font><font size=\"2\"></font></font></b> <br>กรุณากรอก<font color=\"#CC0000\">\"ชื่อ-สกุล\"</font>
<br><a href=\"javascript:history.go(-1);\"><img src=\"images/back.gif\" width=\"37\" height=\"14\" border=\"0\"></a>"; }

else if ($email=='') { echo "<b><font color=\"#CC9933\"><font size=\"3\" face=\"Verdana, Arial, Helvetica, sans-serif\" color=\"#CC0000\">Error</font><font size=\"2\"></font></font></b> <br>กรุณากรอก <font color=\"#CC0000\">\"อีเมล์\"</font>
<br><a href=\"javascript:history.go(-1);\"><img src=\"images/back.gif\" width=\"37\" height=\"14\" border=\"0\"></a>"; }


else {
			 $msg="
<strong>แบบฟอร์มการจองห้อง</strong><br />

ชื่อ-สกุล= $name<br />
บริษัท—= $company<br />
อีเมล์= $email<br />
โทรศัพท์= $telephone<br />
โทรสาร= $fax<br />
มือถือ= $mobile<br />
ที่อยู่= $address<br />
เมือง= $city<br />
จังหวัด= $state<br />
ประเทศ= $country<br />
รหัสไปรษณีย์= $pastalcode<br />

ประเภทบริการ= $service $virtual $metting<br />

<strong>ขนาดสำนักงาน</strong><br /> 
กว้าง= $width<br />
ยาว= $length<br />
จำนวนพนักงาน= $staff<br />
ปริมาณการเวลาใช้เวลา= $date / $month / $year<br />
ความต้องการเพิ่มเติมพิเศษ= $requirements<br />
...
<br><a href=\"contact.htm\"><img src=\"images/back.gif\" width=\"37\" height=\"14\" border=\"0\"></a>";
			 ...
			 echo "Error";
                                ...
                                <b><br>
                                ABP บริการสำนักงานให้เช่าและห้องประชุมสัมมนา ตั้งอยู่ใจกลางจังหวัดเชียงใหม่ 
                                พื้นที่ยุทธศาสตร์ด้านเศรษฐกิจและการลงทุนเขตภาคเหนือของไทยและภูมิภาคอินโดจีน 
                                ทำเลสำคัญสำหรับธุรกิจของท่าน</b></font></strong></p>
                              <p align="left">โทรศัพท์ : 66-53-203456<br>
                                อีเมล์ : contact@abp-businesscentre.com<br>
                                หรือกรอกข้อมูลในแบบฟอร์มด้านล่างเพื่อ ABP ติดต่อกลับท่าน</p>
                            </div>
                        </td>
                      </tr>
                      <tr> 
                        <td height="370">
                          <table width="400" cellpadding="0" cellspacing="0" border="0">
                              <tr> 
                                <td width="175" valign="top"><b>ชื่อ - สกุล<font color="#FF0000">*</font></b></td>
                                <td width="334"><font color="#CC9933"> 
                                  <? echo $name; ?>
                                  </font></td>
                              </tr>
                              <tr> 
                                <td width="175" valign="top"><strong>บริษัท</strong></td>
                                <td width="334"> <font color="#CC9933"> 
                                  <? echo $company; ?>
                                  </font></td>
                              </tr>
                              <tr> 
                                <td width="175" valign="top"><b>อีเมล์<font color="#FF0000">*</font></b></td>
                                <td width="334"> <font color="#CC9933"> 
                                  <? echo $email; ?>
                                  </font></td>
                              </tr>
                              <tr> 
                                <td width="175" valign="top"><strong>โทรศัพท์</strong></td>
                                <td width="334"> <font color="#CC9933"> 
                                  <? echo $telephone; ?>
                                  </font></td>
                              </tr>
                              <tr> 
                                <td width="175" valign="top"><strong>โทรสาร</strong></td>
                                <td width="334"><font color="#CC9933"> 
                                  <? echo $fax; ?>
                                  </font></td>
                              </tr>
                              <tr> 
                                <td width="175" valign="top"><strong>มือถือ</strong></td>
                                <td width="334"><font color="#CC9933"> 
                                  <? echo $mobile; ?>
                                  </font></td>
                              </tr>
                              <tr> 
                                <td width="175" valign="top"><strong>ที่อยู่</strong></td>
                                <td width="334"><font color="#CC9933"> 
                                  <? echo $address; ?>
                                  </font></td>
                              </tr>
                              <tr> 
                                <td width="175" valign="top"><strong>เมือง </strong></td>
                                <td width="334"><font color="#CC9933"> 
                                  <? echo $city; ?>
                                  </font></td>
                              </tr>
                              <tr> 
                                <td width="175" valign="top"><strong>จังหวัด</strong></td>
                                <td width="334"><font color="#CC9933"> 
                                  <? echo $state; ?>
                                  </font></td>
                              </tr>
                              <tr> 
                                <td valign="top"><strong>ประเทศ</strong> </td>
                          ...
                          <table width="400" cellpadding="0" cellspacing="0" border="0">
                            <tr> 
                                <td width="133" valign="top"><strong>ประเภทบริการ</strong></td>
                            ...
                            <tr> 
                                <td width="133" valign="top"><strong>ขนาดสำนักงาน 
                                  </strong></td>
                                <td width="128" valign="top"> <font color="#CC9933"> 
                                  <? echo $width; ?>
                                  </font></td>
                            ...
                            <tr> 
                                <td width="133" valign="top"><strong>จำนวนพนักงาน</strong></td>
                                <td width="128" valign="top"><b> <font color="#CC9933"> 
                                  <? echo $staff; ?>
                                  </font></b></td>
                              <td width="139"><b></b></td>
                            </tr>
                            <tr> 
                                <td width="133" valign="top"><strong>ปริมาณการเวลาใช้เวลา</strong></td>
                                <td colspan="2" valign="top"><b> <font color="#CC9933"> 
                                  <? echo $date; ?>
                                  / <font color="#CC9933"> 
                                  <? echo $month; ?>
                                  /<font color="#CC9933"> 
                            ...
                            <tr> 
                                <td width="133" height="20" valign="top"><strong>ความต้องการ<br>
                                  เพิ่มเติมพิเศษ</strong></td>
                                <td colspan="2" valign="top"> <p><b><font color="#CC9933"> 
                                    <? echo $requirements; ?>
                                    </font></b></p>
                              </td>
                            </tr>
