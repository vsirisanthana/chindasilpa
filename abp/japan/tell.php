    ...
    <td valign="top"> <br>
      <table width="772" border="0">
        <tr> 
          ...
          <td width="529" valign="top"><!-- #BeginEditable "hd" --> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="570" height="251">
                    ...
                    <param name=quality value=high>
                    <param name="wmode" value="transparent">
                    <embed src="head.swf" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="570" height="251" wmode="transparent">
                    </embed> 
                  </object></td>
              </tr>
            </table>
          ...
          <td width="529" valign="top">
            <table width="100%">
              <tr> 
                ...
                <td valign="top"><!-- #BeginEditable "boo" --><b>แนะนำ Links</b> 
                  <div align="right">
                    <p align="left">
                      <?php
