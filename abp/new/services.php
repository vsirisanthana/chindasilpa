	...
	<div id="site_left">
       ...
       <script type="text/JavaScript">
		$(document).ready(function(){
   	   ...
   	   <div id='slideshowHolderContent'> <img src='img/services_p1.jpg'  /> <img src='img/services_p2.jpg'  /> </div>
   	  </div>
   	  <!--End banner_home-->
        
        <div id="content">
        	<div class="lang"><a href="services_th.php"><img src='img/flag_th.jpg' border="0" alt="Thai" /></a> <img src='img/flag_en.jpg' border="0"/></div>
         	<div class="clear"></div>
                    	...
                    	<div class="Boxcontainer">
                        	<div class="Boxcontent">
                            	...
                            	<div class="titleservice">ABP Business Centre</div><br />
   								...
   								<p>Other than our traditional office space for rent, we also offer “Business Centre” services which include smart office, virtual office and meeting room. ABP Business Centre is the platform for doing business in Chiang Mai on flexible terms. All services you need for your business is ready for your on-demand  to save your time and capital investment. Most importantly, you free up resources to focus on your core activities and leave the rest with us. </p>
   								<br />
                                
                           		<span>Smart Office</span><br />
                               	<p>We offer 22 units of fully furnished offices; size 10-20 square meters, located on the 2nd floor of building A. You can have the feel of an ordinary office with a physical mailing address, receptionist, post mail and call managing services. Communication and Secretarial services include direct telephone lines, fax, internet, printing, scanning, copying as well as translations, interpretation and typing. You are secured with door accessed with fingerprint scan, 24/7 security, and CCTV.</p>
                                
                                <span>Virtual Office</span><br />
                                <p>ABP Virtual office is ideal for businessmen demanding high mobility functions yet complete and professional. We offer a physical mailing address for business registration, live attendance, communication and secretarial services.</p>
                                
                                <span>Meeting Room</span><br />
                                <p>We offer 2 meeting rooms with presentation services. Refreshments and coffee breaks are also available.</p>
                                
                                <span>Contact</span><br />
                                Tel: 053-203456<br />
                                Fax: 053-203460<br />
                                email: contact@abp-businesscentre.com<br /><br />
                                
                                <div class="titleservice">EVENT VENUE</div><br />
                                <p>Our green landscape is an ideal location for your outdoor special event such as weddings or product launch parties. Our indoor space is also suitable for expo and exhibitions. You can have common facilities such as parking space and clean bathroom while enjoy the unique atmosphere.</p>
                                
                                <div class="titleservice">RETAIL SPACE</div><br />
                                <p>We have up to 240 square meters of retail space in building B and 80 square meters in building A for business such as convenient stores, coffee shop, salon and book store.</p>
                                </div>
                            </div>
                        </div>
        	...
        	<div class="nav">
            	<li><a href="index.php" target="_top" onClick="MM_nbGroup('down','group1','menu01','img/menu/b1_down.png',1)" onMouseOver="MM_nbGroup('over','menu01','img/menu/b1_over.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu01" src="img/menu/b1_none.png" alt="" onload="" border="0" /></a></li>
             	...
             	<li><a href="facilities.php" target="_top" onClick="MM_nbGroup('down','group1','menu05','img/menu/b5_down.png',1)" onMouseOver="MM_nbGroup('over','menu05','img/menu/b5_over.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu05" src="img/menu/b5_none.png" alt="" onload="" border="0"></a></li>
              	...
              	<li><a href="services.php" target="_top" onClick="MM_nbGroup('down','group1','menu07','img/menu/b7_down.png',1)" onMouseOver="MM_nbGroup('over','menu07','img/menu/b7_down.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu07" src="img/menu/b7_down.png" alt="" onload="" border="0"></a></li>
