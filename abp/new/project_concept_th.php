       ...
       <script type="text/JavaScript">
		$(document).ready(function(){
           ...
           <div id='slideshowHolderContent'>
                    <img src='img/procon_p1.jpg'  />
                    <img src='img/procon_p2.jpg'  />
            </div> 

      </div><!--End banner_home-->
        
        <div id="content">
			<div class="lang"><img src='img/flag_th.jpg' border="0" alt="Thai" /> <a href="project_concept.php"><img src='img/flag_en.jpg' border="0"/></a></div>
         	<div class="clear"></div>
            	 ...
            	 <div id="mcs_container">  
                	<div class="customScrollBox">
                    	<div class="Boxcontainer">
                            ...
                            <div class="concept">
                			<p>บริษัท  จินดาศิลป์ จำกัด ผู้ก่อตั้ง  Airport Business Park (ABP) ใน พ.ศ. 2539 ให้บริการพื้นที่เช่าเพื่อสำนักงาน และ ABP Business Center เป็นสำนักงานพร้อมใช้ ด้วยแรงบันดาลใจจากความเติบโตที่รวดเร็วของจังหวัดเชียงใหม่         ในฐานะศูนย์กลางธุรกิจของภูมิภาคระดับประเทศและระดับนานาประเทศ ความเชี่ยวชาญและบริการที่อบอุ่นเป็นมิตรและเป็นมืออาชีพ สร้างให้แบรนด์ ABP เป็นที่รู้จักยอมรับในวงกว้าง ส่งผลให้โครงการที่ 1 ประสบความสำเร็จอย่างดียิ่ง</p>
                            <p>ขณะที่จังหวัดเชียงใหม่ยังคงมีอัตราเติบโตต่อเนื่องเป็นที่สนใจ             ของนักลงทุน นักธุรกิจทั้งชาวไทยและต่างประเทศ จึงได้ขยาย              สร้างอาคารเพิ่มเติมอีกสองตึก ที่ออกแบบก่อสร้างท่ามกลางทัศนียภาพของสวนสวย สะอาด ร่มรื่นและการรักษาความปลอดภัยที่ได้รับการไว้วางใจจากสำนักงานส่วนราชการ และเอกชนทั้งไทยและต่างประเทศ</p>
                            </div>
    	...
    	<div id="menu">
        	<div class="nav">
            	<li><a href="index_th.php" target="_top" onClick="MM_nbGroup('down','group1','menu01','img/menu/b1_down.png',1)" onMouseOver="MM_nbGroup('over','menu01','img/menu/b1_over.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu01" src="img/menu/b1_none.png" alt="" onload="" border="0" /></a></li>
           	  ...
           	  <li><a href="project_concept_th.php" target="_top" onClick="MM_nbGroup('down','group1','menu03','img/menu/b3_down.png',1)" onMouseOver="MM_nbGroup('over','menu03','img/menu/b3_down.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu03" src="img/menu/b3_down.png" alt="" onload="" border="0" /></a></li>
