...
<div id="container">
	<div id="site_left">
		...
		$(document).ready(function(){
			$('#slideshowHolder').jqFancyTransitions({ effect: 'curtain',width: 735, height: 482,strips: 20,stripDelay: 50,position: 'alternate',direction: 'fountainAlternate' });
		});
		</script>
           <div id='slideshowHolder'>
                    <img src='img/index_p1.jpg' />
                    <img src='img/index_p2.jpg' />
                    <img src='img/index_p3.jpg' />
                    <img src='img/index_p4.jpg' />
            </div> 

      </div><!--End banner_home-->
        
        <div id="content">
       <!-- <div class="lang"><img src='img/flag_th.jpg' border="0" alt="Thai" /> <a href="index.php"><img src='img/flag_en.jpg' border="0"/></a></div> -->
        <div class="clear"></div>
        <div class="texthome">
        <span style="color:#FCAE10">"</span> Make Your Business Destination a Green One <br />
        <span style=" float:right;font-size:18px; padding-right:50px;"><span style="color:#FCAE10">@ AIRPORT BUSINESS PARK "</span></span></div>
        </div><!--End content-->
</div><!--End site_left-->
    ...
    <div id="site_right">
    	<div id="menu">
        	<div class="nav">
            <ul>
            	<li><a href="index_th.php" target="_top" onClick="MM_nbGroup('down','group1','menu01','img/menu/b1_down.png',1)" onMouseOver="MM_nbGroup('over','menu01','img/menu/b1_over.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu01" src="img/menu/b1_down.png" alt="" onload="" border="0" /></a></li>
