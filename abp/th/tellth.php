          ...
          <td width="529" valign="top">
            <table width="100%">
              <tr> 
                ...
                <td valign="top"><!-- #BeginEditable "boo" --><font size="3"><b>ส่ง 
                  Links ให้เพื่อน</b></font><b> <br>
  <? if (empty($HTTP_REFERER)) { $referrer = 'No referrer reported'; } else { $referrer = $HTTP_REFERER; } echo $referrer; ?>                <br>
                  </b> 
                  <div align="right"> 
                    <p align="left"> 
                      <?php
...
<? if (empty($HTTP_REFERER)) { $referrer = 'No referrer reported'; } else { $referrer = $HTTP_REFERER; } echo $referrer; ?>
                            ...
                            <br>
                            <br>
                            <input name="submit" type=submit value=ส่งข้อความ></td>
                        </tr>
                      </table>
                      <div align="left"><br>
                        <br>
