	...
	<div id="site_left">
   	  <div id="gallery">
            ...
            <div id="basic" class="svwp">
              <ul>
                <li><img width="735" height="482" src="img/gallery/p1.jpg" /></li>
                <li><img width="735" height="482" src="img/gallery/p2.jpg" /></li>
                <li><img width="735" height="482" src="img/gallery/p3.jpg" /></li>
                <li><img width="735" height="482" src="img/gallery/p4.jpg" /></li>
                <li><img width="735" height="482" src="img/gallery/p5.jpg" /></li>
                <li><img width="735" height="482" src="img/gallery/p6.jpg" /></li>
                <li><img width="735" height="482" src="img/gallery/p7.jpg" /></li>
                <li><img width="735" height="482" src="img/gallery/p8.jpg" /></li>
                <li><img width="735" height="482" src="img/gallery/p9.jpg" /></li>
                <li><img width="735" height="482" src="img/gallery/p10.jpg" /></li>
                <li><img width="735" height="482" src="img/gallery/p11.jpg" /></li>
                <li><img width="735" height="482" src="img/gallery/p12.jpg" /></li>
                <li><img width="735" height="482" src="img/gallery/p13.jpg" /></li>
                <li><img width="735" height="482" src="img/gallery/p14.jpg" /></li>
                <li><img width="735" height="482" src="img/gallery/p15.jpg" /></li>
                <li><img width="735" height="482" src="img/gallery/p16.jpg" /></li>
                <li><img width="735" height="482" src="img/gallery/p17.jpg" /></li>
                <li><img width="735" height="482" src="img/gallery/p18.jpg" /></li>
                <li><img width="735" height="482" src="img/gallery/p19.jpg" /></li>
                <li><img width="735" height="482" src="img/gallery/p20.jpg" /></li>
              </ul>
            </div>
...
<!--<div class="flag"><a href="gallery_th.php"><img src='img/flag_th.jpg' border="0" alt="Thai" /></a> <img src='img/flag_en.jpg' border="0"/></div> -->		
      </div><!--End banner_home-->
        
        <!--<div id="content">
         <div class="lang"><a href="gallery_th.php"><img src='img/flag_th.jpg' border="0" alt="Thai" /></a> <img src='img/flag_en.jpg' border="0"/></div>
         <div class="clear"></div>
    	...
    	<div id="menu">
        	<div class="nav">
            	<li><a href="index.php" target="_top" onClick="MM_nbGroup('down','group1','menu01','img/menu/b1_down.png',1)" onMouseOver="MM_nbGroup('over','menu01','img/menu/b1_over.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu01" src="img/menu/b1_none.png" alt="" onload="" border="0" /></a></li>
           	  	<li><a href="gallery.php" target="_top" onclick="MM_nbGroup('down','group1','menu02','img/menu/b2_down.png',1)" onmouseover="MM_nbGroup('over','menu02','img/menu/b2_down.png','',1)" onmouseout="MM_nbGroup('out')"><img name="menu02" src="img/menu/b2_down.png" alt="" onload="" border="0" /></a></li>
