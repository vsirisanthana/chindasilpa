...
<div id="container">
	<div id="site_left">
       ...
       <script type="text/JavaScript">
        ...
        <div id="content">
        	<div class="lang"><a href="facilities_th.php"><img src='img/flag_th.jpg' border="0" alt="Thai" /></a> <img src='img/flag_en.jpg' border="0"/></div>
         	<div class="clear"></div>
            <div class="textcontent">
            At Airport Business Park, we offer
            <ul style="line-height:20px;">
                <li>Indoor parking structure for 200 cars & outdoor parking for more than 200 cars</li>
                <li>Passenger & service lifts</li>
                <li>Air conditioning system</li>
                <li>Direct telephone and Internet line with the option for lease line</li>
                <li>Reception & mailing services</li>
                <li>Cafeteria & small retail area</li>
                <li>Cleaning and pest control service for the common area</li>
                <li>24-hour security with CCTV and finger scan access points</li>
                <li>Fire alarm, smoke detectors and fire extinguish system</li>
                <li>On-site maintenance service</li>
                <li>Sanitation system and waste water treatment</li>
                <li>Area for electrical generators</li>
                </ul>
            </div>
        </div><!--End content-->
</div><!--End site_left-->
    	...
    	<div id="menu">
        	<div class="nav">
            	<li><a href="index.php" target="_top" onClick="MM_nbGroup('down','group1','menu01','img/menu/b1_down.png',1)" onMouseOver="MM_nbGroup('over','menu01','img/menu/b1_over.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu01" src="img/menu/b1_none.png" alt="" onload="" border="0" /></a></li>
             	...
             	<li><a href="facilities.php" target="_top" onClick="MM_nbGroup('down','group1','menu05','img/menu/b5_down.png',1)" onMouseOver="MM_nbGroup('over','menu05','img/menu/b5_down.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu05" src="img/menu/b5_down.png" alt="" onload="" border="0"></a></li>
                ...
                <li><a href="faq.php" target="_top" onClick="MM_nbGroup('down','group1','menu10','img/menu/b10_down.png',1)" onMouseOver="MM_nbGroup('over','menu10','img/menu/b10_none.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu10" src="img/menu/b10_none.png" alt="" onload="" border="0"></a></li>
          </div>
      </div><!--End menu-->
        <div id="address">
