...
jQuery.fn.slideViewerPro = function(settings) {
	  settings = jQuery.extend({
			...
			thumbsActiveBorderColor: "#FCAE10",
			buttonsTextColor: "#FCAE10",
			...
			leftButtonInner: "<img src='img/btn_left.png' />", //could be an image "<img src='images/larw.gif' />" or an escaped char as "&larr";
			rightButtonInner: "<img src='img/btn_right.png' />", //could be an image or an escaped char as "&rarr";
			autoslide: false,
			typo: false,
			typoFullOpacity: 0.9,
			shuffle: false
