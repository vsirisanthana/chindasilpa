...
<div id="container">
	<div id="site_left">
        ...
        <div id="content">
         <div class="lang"><img src='img/flag_th.jpg' border="0" alt="Thai" /> <a href="location.php"><img src='img/flag_en.jpg' border="0"/></a></div>
         <div class="clear"></div>
         <div class="textcontent"><span style="font-size:18px;">แอร์พอร์ต บิซิเนส พาร์ก </span> ตั้งอยู่บนถนนมหิดล ใกล้สนามบินนานาชาติเชียงใหม่ ตรงข้ามเซ็นทรัลแอร์พอร์ต พลาซ่า ห่างจากถนนนิมมานเหมินห์ และตัวเมืองเชียงใหม่เพียง 10 นาที
        <ul style="float:right;line-height:20px;">
        	<li>ห่างจากตัวเมืองเชียงใหม่เพียง 10 นาที</li>
            <li>ห่างจากสนามบินนานาชาติเชียงใหม่เพียง 5 นาที</li>
        </ul>
        </div>
        	...
        	<div class="nav">
            	<li><a href="index_th.php" target="_top" onClick="MM_nbGroup('down','group1','menu01','img/menu/b1_down.png',1)" onMouseOver="MM_nbGroup('over','menu01','img/menu/b1_over.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu01" src="img/menu/b1_none.png" alt="" onload="" border="0" /></a></li>
             	...
             	<li><a href="facilities_th.php" target="_top" onClick="MM_nbGroup('down','group1','menu05','img/menu/b5_down.png',1)" onMouseOver="MM_nbGroup('over','menu05','img/menu/b5_over.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu05" src="img/menu/b5_none.png" alt="" onload="" border="0"></a></li>
              	...
              	<li><a href="location_th.php" target="_top" onClick="MM_nbGroup('down','group1','menu08','img/menu/b8_down.png',1)" onMouseOver="MM_nbGroup('over','menu08','img/menu/b8_down.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu08" src="img/menu/b8_down.png" alt="" onload="" border="0"></a></li>
