...
<div id="container">
	<div id="site_left">
       ...
       <script type="text/JavaScript">
        ...
        <div id="content">
        	<!--<div class="lang"><a href="download_th.php" target="_top"><img src='img/flag_th.jpg' border="0" alt="Thai" /></a> <img src='img/flag_en.jpg' border="0"/></div> -->
         	<div class="clear"></div>
    ...
    <div id="site_right">
    	<div id="menu">
        	<div class="nav">
				...
				<li><a href="download.php" target="_top" onClick="MM_nbGroup('down','group1','menu09','img/menu/b9_down.png',1)" onMouseOver="MM_nbGroup('over','menu09','img/menu/b9_down.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu09" src="img/menu/b9_down.png" alt="" onload="" border="0"></a></li>
