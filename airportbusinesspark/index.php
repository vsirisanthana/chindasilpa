...
<div id="container">
	<div id="site_left">
        ...
        <div id="content">
       <!-- <div class="lang"><a href="index_th.php"><img src='img/flag_th.jpg' border="0" alt="Thai" /></a> <img src='img/flag_en.jpg' border="0"/></div> -->
        <div class="clear"></div>
        <div class="texthome">
    ...
    <div id="site_right">
    	<div id="menu">
        	<div class="nav">
            <ul>
            	<li><a href="index.php" target="_top" onClick="MM_nbGroup('down','group1','menu01','img/menu/b1_down.png',1)" onMouseOver="MM_nbGroup('over','menu01','img/menu/b1_over.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu01" src="img/menu/b1_down.png" alt="" onload="" border="0" /></a></li>
