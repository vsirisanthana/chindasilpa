...
<div id="container">
	<div id="site_left">
        ...
        <div id="content">
         <div class="lang"><a href="location_th.php"><img src='img/flag_th.jpg' border="0" alt="Thai" /></a> <img src='img/flag_en.jpg' border="0"/></div>
         <div class="clear"></div>
         <div class="textcontent"><span style="font-size:18px;">Airport Business Park</span> is on Mahidol road, closed to Chiang Mai International Airport and Airport Plaza Department Store.  It is 10 minutes from Nimmanhemin business area and from city center.
        <ul style="float:right; line-height:20px;">
        	<li>10 minutes from the city center</li>
            <li>5 minutes from the airport</li>
        </ul>
        </div>
        	...
        	<div class="nav">
            	<li><a href="index.php" target="_top" onClick="MM_nbGroup('down','group1','menu01','img/menu/b1_down.png',1)" onMouseOver="MM_nbGroup('over','menu01','img/menu/b1_over.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu01" src="img/menu/b1_none.png" alt="" onload="" border="0" /></a></li>
             	...
             	<li><a href="facilities.php" target="_top" onClick="MM_nbGroup('down','group1','menu05','img/menu/b5_down.png',1)" onMouseOver="MM_nbGroup('over','menu05','img/menu/b5_over.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu05" src="img/menu/b5_none.png" alt="" onload="" border="0"></a></li>
              	...
              	<li><a href="location.php" target="_top" onClick="MM_nbGroup('down','group1','menu08','img/menu/b8_down.png',1)" onMouseOver="MM_nbGroup('over','menu08','img/menu/b8_down.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu08" src="img/menu/b8_down.png" alt="" onload="" border="0"></a></li>
