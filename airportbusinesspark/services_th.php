       ...
       <script type="text/JavaScript">
		$(document).ready(function(){
           ...
           <div id='slideshowHolderContent'>
                    <img src='img/services_p1.jpg'  />
                    <img src='img/services_p2.jpg'  />
            </div> 

      </div><!--End banner_home-->
        
        <div id="content">
        	<div class="lang"><img src='img/flag_th.jpg' border="0" alt="Thai" /> <a href="services.php"><img src='img/flag_en.jpg' border="0"/></a></div>
         	<div class="clear"></div>
                	...
                	<div class="customScrollBox">
                    	<div class="Boxcontainer">
                        	<div class="Boxcontent">
                            	<div class="service">
                            	<div class="titleservice">ABP BUSINESS CENTRE</div><br />
                                
   								<p>นอกเหนือจากการบริการพื้นที่สำนักงานแล้ว ABP ยังนำเสนอบริการสำนักงานสมัยใหม่ ภายใต้ชื่อ Business Centre ซึ่งประกอบไปด้วย smart office, virture office และห้องประชุม ที่ปฏิวัติการจัดการพื้นที่เพื่อดำเนินธุรกิจด้วยความชำนาญและบริการทางเลือกที่หลากหลายตามรูปแบบ ความต้องการของท่าน ด้วยเงื่อนไขสัญญาที่สะดวกและยืดหยุ่น ทุกบริการที่จำเป็นสำหรับพื้นที่สำนักงานธุรกิจมีพร้อมให้บริการเพื่อความประหยัดทั้งเงินทุนและเวลาของท่าน ประการสำคัญที่สุดคืออิสระจากการแบกรับต้นทุนและภาระการบำรุงรักษาทรัพยากรจำเป็นในการดำเนินธุรกิจ เพื่อที่ท่านจะได้มีเวลาเดินเครื่องธุรกิจของท่านอย่างเต็มที่และบรรลุความสำเร็จที่รออยู่ข้างหน้าอย่างรวดเร็ว </p>
                                
                           		<span>Smart Office</span><br />
                            <p>   สำหรับนักธุรกิจที่ต้องการพื้นที่สำนักงานตกแต่งพร้อมเฟอร์นิเจอร์และอุปกรณ์สิ่งอำนวยความสะดวกเพื่อการทำงานอย่างมืออาชีพ เราจัดสรรพื้นที่ 22 ยูนิต ขนาด 10-20 ตรม. บนชั้น 2 ของอาคาร A พร้อมที่อยู่สำหรับจัดส่งจดหมายพัสดุไปรษณีย์ พนักงานต้อนรับ การรับฝาก-โอน-จัดการข้อความนัดหมายทางธุรกิจ เรามีบริการด้านการสื่อสารข้อมูลและเลขานุการสำนักงาน เช่น โทรศัพท์สายตรง โทรสาร อินเตอร์เน็ตความเร็วสูง การพิมพ์ สแกนเอกสาร สำเนา รวมทั้งบริการ แปลเอกสาร และพิมพ์งาน อีกทั้งยังมีบริการรักษาความปลอดภัยครบครัน ทั้งระบบประตูสแกนด้วยรอยพิมพ์นิ้ว เจ้าหน้าที่รักษาความปลอดภัย 24 ชั่วโมงและ CCTV</p>
                                
                                <span>Virtual Office</span><br />
                        <p>       สำนักงานเสมือนเหมาะสำหรับนักธุรกิจที่ต้องเดินทางอยู่ตลอด เพราะถึงแม้จะไม่มีพื้นที่สำนักงาน แต่ยังมีความเป็นมืออาชีพอย่างครบครัน ด้วยที่อยู่สำหรับจัดส่งจดหมายพัสดุไปรษณีย์ และจดทะเบียนการค้า พนักงานต้อนรับ บริการด้านการสื่อสารข้อมูลและเลขานุการสำนักงาน</p>
                                
                                <span>Meeting Room</span><br />
                          <p>     เรามีพื้นที่สำหรับจัดประชุม สัมมนา ฝึกอบรม และนำเสนอแนวคิดธุรกิจแก่คู่ค้า/ลูกค้าคนสำคัญของท่าน    ด้วยโสตทัศนูปกรณ์ที่ครบครันทันสมัย ท่านยังสามารถสั่งเครื่องดื่มและอาหารว่างสำหรับผู้มาประชุมได้ด้วย</p>
                                
                                <span>Contact</span><br />
                                โทรศัพท์: 053-203456<br />
                               โทรสาร:  053-203460<br />
                               อีเมล์: contact@abp-businesscentre.com<br /><br />
                                
                                <div class="titleservice">EVENT VENUE</div><br />
                               <p> พื้นที่สวนสวยภายในโครงการของ ABP ควรจะเป็นสถานที่ที่่ท่านกำลังหาในการจัดงานต่างๆ เช่นงานแต่งงาน หรืองานเปิดตัวสินค้า พื้นที่โล่งภายในตึกอาจจะตอบโจทย์ของท่านในงานแสดงสินค้าหรือนิทรรศการ เรามีสิ่งอำนวยความสะดวกเช่น ที่จอดรถในร่มและห้องน้ำสะอาด</p>
                                
                                <div class="titleservice">RETAIL SPACE</div><br />
                               <p>ในโครงการ ABP เรามีพื้นที่กว่า 240 ตรม. สำหรับผู้ที่สนใจเปิดร้านกาแฟ ร้านสะดวกซื้อ ร้านทำผม หรือร้านหนังสือ ในอาคาร B และ 80 ตรม. ในอาคาร A</p>
                                </div>
                            </div>
                        </div>
        	...
        	<div class="nav">
            	<li><a href="index_th.php" target="_top" onClick="MM_nbGroup('down','group1','menu01','img/menu/b1_down.png',1)" onMouseOver="MM_nbGroup('over','menu01','img/menu/b1_over.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu01" src="img/menu/b1_none.png" alt="" onload="" border="0" /></a></li>
             	...
             	<li><a href="facilities_th.php" target="_top" onClick="MM_nbGroup('down','group1','menu05','img/menu/b5_down.png',1)" onMouseOver="MM_nbGroup('over','menu05','img/menu/b5_over.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu05" src="img/menu/b5_none.png" alt="" onload="" border="0"></a></li>
              	...
              	<li><a href="services_th.php" target="_top" onClick="MM_nbGroup('down','group1','menu07','img/menu/b7_down.png',1)" onMouseOver="MM_nbGroup('over','menu07','img/menu/b7_down.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu07" src="img/menu/b7_down.png" alt="" onload="" border="0"></a></li>
