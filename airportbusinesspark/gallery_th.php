...
<!--<div class="flag"><img src='img/flag_th.jpg' border="0" alt="Thai" /> <a href="gallery.php"><img src='img/flag_en.jpg' border="0"/></a></div> -->
      </div><!--End banner_home-->
    	...
    	<div id="menu">
        	<div class="nav">
            	<li><a href="index_th.php" target="_top" onClick="MM_nbGroup('down','group1','menu01','img/menu/b1_down.png',1)" onMouseOver="MM_nbGroup('over','menu01','img/menu/b1_over.png','',1)" onMouseOut="MM_nbGroup('out')"><img name="menu01" src="img/menu/b1_none.png" alt="" onload="" border="0" /></a></li>
           	  	<li><a href="gallery_th.php" target="_top" onclick="MM_nbGroup('down','group1','menu02','img/menu/b2_down.png',1)" onmouseover="MM_nbGroup('over','menu02','img/menu/b2_down.png','',1)" onmouseout="MM_nbGroup('out')"><img name="menu02" src="img/menu/b2_down.png" alt="" onload="" border="0" /></a></li>
